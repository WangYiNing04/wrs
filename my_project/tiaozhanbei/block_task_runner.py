...
LastEditTime: 2025-10-29 06:03:00
FilePath: /wrs_tiaozhanbei/my_project/tiaozhanbei/block_task_runner.py
Description: 
...
import time
import traceback
from my_project.tiaozhanbei.stack_blocks_three.task_block import MultiCameraBlockTask


class BlockTaskRunner:
    def __init__(self):
        print("🚀 初始化多摄像头方块抓取任务中...")
        self.task = MultiCameraBlockTask()
        # 初始化机械臂为零位
