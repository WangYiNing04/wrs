...
LastEditTime: 2025-10-28 03:49:22
FilePath: /wrs_tiaozhanbei/my_project/tiaozhanbei/bowl_task_runner.py
Description: 
...
from my_project.tiaozhanbei.stack_bowls_three.task_bowl import MultiCameraBowlTask


class BowlTaskRunner:
    def __init__(self):
        print("🚀 初始化多摄像头碗抓取任务中...")
        self.task = MultiCameraBowlTask()
        # 初始化机械臂为零位
