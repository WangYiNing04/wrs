'''
Author: wang yining
Date: 2025-10-30 21:44:35
LastEditTime: 2025-10-31 00:09:55
FilePath: /wrs_tiaozhanbei/my_project/tiaozhanbei/task_sim/show_trajector.py
Description: 
...
print(mot_data)
# 直接显示完整轨迹（去掉动画控制部分）
for mesh_model in mot_data.jv_list:
    print(mesh_model)
