...
## object holder (起始位置)
holder_1 = mcm.CollisionModel(r"/home/wyn/PycharmProjects/wrs_tiaozhanbei/0000_examples/objects/tiaozhanbei/bowl.stl")
holder_1.rgba = rm.np.array([.5, .5, .5, 1])
h1_gl_pos = np.array([0.27036765, -0.51372601, 0])
...
holder_2 = mcm.CollisionModel(r"/home/wyn/PycharmProjects/wrs_tiaozhanbei/0000_examples/objects/tiaozhanbei/bowl.stl")
...
previous_available_gids = ppp.reason_common_gids(
                           grasp_collection,
                           goal_pose_list,
                           obstacle_list=obstacle_list,
                           toggle_dbg=False)
