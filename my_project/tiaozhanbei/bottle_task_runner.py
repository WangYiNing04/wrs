...
LastEditTime: 2025-10-29 06:23:12
FilePath: /wrs_tiaozhanbei/my_project/tiaozhanbei/bottle_task_runner.py
Description: 
...
import time
import traceback
from my_project.tiaozhanbei.put_bottles_dustbin.task_bottle import MultiCameraBottleTask


class BottleTaskRunner:
    def __init__(self):
        print("🚀 初始化多摄像头瓶子抓取任务中...")
        self.task = MultiCameraBottleTask()
        # 初始化机械臂为零位
